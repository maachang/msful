...
module.exports.createMsFUL = function (port, timeout, contentsCacheMode, args_env) {
  'use strict';
  var _u = undefined
  ...
  // 実行環境の設定.
  initMod.setEnvironment(_MSFUL_ENV);
  ...
  console.info("## listen: " + bindPort + " env:[" + _MSFUL_ENV + "] timeout:" + (httpTimeout/1000) + "(sec) contentCache:" + _CACHE + " pid:" + process.pid);
  server = null;
}
