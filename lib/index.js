      ...
      fs.readFile(name, function (err, src) {
        ...
        try {
          ...
          src = "return (function(_g) {\n" +
            ...
            "var params = _getPms(request, response, args.data)\n" +
            "var redirect = _redirect\n" +
            "args = null\n" +
            "_getPms = null\n" +
            src +
            "\n})(global)";
          var eres = new Function('args', '_getPms', '_redirect' , src)(
            { req: req, res: res, headers: headers, data: data }, _getPms, function(url, status) {
